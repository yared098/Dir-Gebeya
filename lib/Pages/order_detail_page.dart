        ...
        child: Row(
          children: [
            Container(
              ...
              child: Image.network(
                "https://direthiopia.com/assets/images/products/${product.productImage}",
                fit: BoxFit.contain,
  ...
  Widget _buildBillingCard(Order order) {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            _buildBillingRow('Product Tax',
                '+ ${order.taxCost.toStringAsFixed(2)} ETB'),
            _buildBillingRow(
                'Sub Total', '${order.total.toStringAsFixed(2)} ETB'),
            const Divider(height: 24),
            _buildBillingRow('Total Refundable Amount',
